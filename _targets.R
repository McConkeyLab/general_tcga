...
mapped <- tar_map(
  ...
  tar_target(b_hrs, get_hr(dds_w_bin_scores, "b_bin", project)),
  tar_target(t_hrs, get_hr(dds_w_bin_scores, "cd8_bin", project)),
  tar_target(imm_hrs, get_hr(dds_w_bin_scores, "imm_bin", project)),
  tar_target(b_survdiff, get_survdiff(dds_w_bin_scores, "b_bin", project)),
  tar_target(t_survdiff, get_survdiff(dds_w_bin_scores, "cd8_bin", project)),
  tar_target(imm_survdiff, get_survdiff(dds_w_bin_scores, "imm_bin", project)),
  tar_target(hi_b_survdiff, get_survdiff(dds_w_bin_scores, "sex", project, b_bin, "Hi")),
  tar_target(lo_b_survdiff, get_survdiff(dds_w_bin_scores, "sex", project, b_bin, "Lo")),
  tar_target(sex_survdiff, get_survdiff(dds_w_bin_scores, "sex", project)),
